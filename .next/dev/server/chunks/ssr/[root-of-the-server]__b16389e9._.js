...
"[project]/app/actions/makeup-slots.ts [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";

/* __next_internal_action_entry_do_not_use__ [{"40668d3a27a2091d8f0d1eb5d76316f56483f24a8b":"deleteMakeupSlot","408571aa441ac93abf0d61247bbd4acc98163266d5":"getAvailableMakeupSlots","6080de15fde0ae1791db5eadca1e87ea55f3248bee":"claimMakeupSlot","60edb09a470cb865e5a3b9cbb0be13e580d2cf1515":"createMakeupSlot"},"",""] */ __turbopack_context__.s([
    "claimMakeupSlot",
    ()=>claimMakeupSlot,
    "createMakeupSlot",
    ()=>createMakeupSlot,
...
;
;
async function getAvailableMakeupSlots(limit = 5) {
    const supabase = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$server$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["createClient"])();
    const now = new Date().toISOString();
    const { data, error } = await supabase.from('makeup_slots').select('*').eq('is_taken', false).gt('start_time', now).order('start_time', {
        ascending: true
    }).limit(limit);
    if (error) {
...
async function claimMakeupSlot(slotId, lessonId) {
    const supabase = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$server$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["createClient"])();
    // Get current user
    const { data: { user } } = await supabase.auth.getUser();
    if (!user) {
    ...
    const { data: lesson, error: lessonError } = await supabase.from('lessons').select('*').eq('id', lessonId).eq('student_id', user.id).single();
    ...
    // Get the makeup slot
    const { data: slot, error: slotError } = await supabase.from('makeup_slots').select('*').eq('id', slotId).eq('is_taken', false).single();
    if (slotError || !slot) {
        return {
    ...
    const { error: updateLessonError } = await supabase.from('lessons').update({
        date: newDate,
        time: newTime,
        status: 'scheduled',
    ...
    const { error: updateSlotError } = await supabase.from('makeup_slots').update({
        is_taken: true,
...
async function createMakeupSlot(startTime, endTime) {
    const supabase = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$server$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["createClient"])();
    // Verify user is admin
    const { data: { user } } = await supabase.auth.getUser();
    if (!user) {
    ...
    const { error } = await supabase.from('makeup_slots').insert({
...
async function deleteMakeupSlot(slotId) {
    const supabase = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$server$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["createClient"])();
    // Verify user is admin
    const { data: { user } } = await supabase.auth.getUser();
    if (!user) {
    ...
    const { error } = await supabase.from('makeup_slots').delete().eq('id', slotId).eq('is_taken', false) // Can only delete unclaimed slots
    ;
    if (error) {
...
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$7_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(getAvailableMakeupSlots, "408571aa441ac93abf0d61247bbd4acc98163266d5", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$7_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(claimMakeupSlot, "6080de15fde0ae1791db5eadca1e87ea55f3248bee", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$7_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(createMakeupSlot, "60edb09a470cb865e5a3b9cbb0be13e580d2cf1515", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$7_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(deleteMakeupSlot, "40668d3a27a2091d8f0d1eb5d76316f56483f24a8b", null);
}),
...
/* __next_internal_action_entry_do_not_use__ [{"4023ff12c20b8171294b3805b284725abc5ce25aa5":"createCheckoutSession"},"",""] */ __turbopack_context__.s([
    "createCheckoutSession",
    ()=>createCheckoutSession
]);
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$7_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/.pnpm/next@16.0.7_react-dom@19.2.0_react@19.2.0__react@19.2.0/node_modules/next/dist/build/webpack/loaders/next-flight-loader/server-reference.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$server$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/supabase/server.ts [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$stripe$40$20$2e$0$2e$0_$40$types$2b$node$40$22$2e$19$2e$2$2f$node_modules$2f$stripe$2f$esm$2f$stripe$2e$esm$2e$node$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/.pnpm/stripe@20.0.0_@types+node@22.19.2/node_modules/stripe/esm/stripe.esm.node.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$7_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$action$2d$validate$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/.pnpm/next@16.0.7_react-dom@19.2.0_react@19.2.0__react@19.2.0/node_modules/next/dist/build/webpack/loaders/next-flight-loader/action-validate.js [app-rsc] (ecmascript)");
;
;
;
const stripe = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$stripe$40$20$2e$0$2e$0_$40$types$2b$node$40$22$2e$19$2e$2$2f$node_modules$2f$stripe$2f$esm$2f$stripe$2e$esm$2e$node$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"](process.env.STRIPE_SECRET_KEY);
...
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$7_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(createCheckoutSession, "4023ff12c20b8171294b3805b284725abc5ce25aa5", null);
}),
"[project]/app/actions/pricing.ts [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";

/* __next_internal_action_entry_do_not_use__ [{"00385c04df9b3ef76b80503a8f8f3f9cf953b0a524":"getCurrentUserPricing","007193d8e62919220cc8ed31c7a9c6cf7aa856315b":"getPricingTiers","404c4fbe07017621d476834309ef7fc95332ebe434":"getPricingForDuration","7034a518d8a6565ddc72644d75fa72831ee796f063":"updatePricingTier"},"",""] */ __turbopack_context__.s([
...
async function getPricingTiers() {
    const supabase = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$server$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["createClient"])();
    const { data, error } = await supabase.from('pricing_tiers').select('*').order('duration');
    if (error) {
...
async function getPricingForDuration(duration) {
    const supabase = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$server$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["createClient"])();
    const { data, error } = await supabase.from('pricing_tiers').select('*').eq('duration', duration).single();
    if (error) {
...
async function updatePricingTier(duration, singlePrice, packPrice) {
    const supabase = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$server$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["createClient"])();
    // Verify user is admin
    const { data: { user } } = await supabase.auth.getUser();
    if (!user) {
...
async function getCurrentUserPricing() {
    const supabase = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$server$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["createClient"])();
    const { data: { user } } = await supabase.auth.getUser();
    if (!user) {
        return {
    ...
    const { data: profile } = await supabase.from('profiles').select('lesson_duration').eq('id', user.id).single();
    const lessonDuration = profile?.lesson_duration || 30;
    // Get pricing for that duration
    const { data: pricing } = await supabase.from('pricing_tiers').select('*').eq('duration', lessonDuration).single();
    return {
        lessonDuration,
        pricing
    };
...
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$7_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(getPricingTiers, "007193d8e62919220cc8ed31c7a9c6cf7aa856315b", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$7_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(getPricingForDuration, "404c4fbe07017621d476834309ef7fc95332ebe434", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$7_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(updatePricingTier, "7034a518d8a6565ddc72644d75fa72831ee796f063", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$7_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(getCurrentUserPricing, "00385c04df9b3ef76b80503a8f8f3f9cf953b0a524", null);
}),
...
"[project]/.next-internal/server/app/student/page/actions.js { ACTIONS_MODULE0 => \"[project]/app/login/actions.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE1 => \"[project]/app/actions/lessons.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE2 => \"[project]/app/actions/makeup-slots.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE3 => \"[project]/app/actions/stripe.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE4 => \"[project]/app/actions/pricing.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE5 => \"[project]/app/messages/actions.ts [app-rsc] (ecmascript)\" } [app-rsc] (server actions loader, ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$actions$2f$makeup$2d$slots$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/actions/makeup-slots.ts [app-rsc] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$actions$2f$pricing$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/actions/pricing.ts [app-rsc] (ecmascript)");
...
__turbopack_context__.s([
    "00385c04df9b3ef76b80503a8f8f3f9cf953b0a524",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$actions$2f$pricing$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getCurrentUserPricing"],
    ...
    "0076f25eb31f28b8758c8fc295882eb2698da5fb07",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$messages$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getAdminProfile"],
    "4023ff12c20b8171294b3805b284725abc5ce25aa5",
    ...
    "408571aa441ac93abf0d61247bbd4acc98163266d5",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$actions$2f$makeup$2d$slots$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getAvailableMakeupSlots"],
    ...
    "40d8d0016c6102c13b5c77e3787f64d07a6b658ace",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$actions$2f$lessons$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["cancelLesson"],
    "6080de15fde0ae1791db5eadca1e87ea55f3248bee",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$actions$2f$makeup$2d$slots$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["claimMakeupSlot"],
    "60cfba80153e6d9e3238b1a802d0edda5ba901fad8",
...
var __TURBOPACK__imported__module__$5b$project$5d2f2e$next$2d$internal$2f$server$2f$app$2f$student$2f$page$2f$actions$2e$js__$7b$__ACTIONS_MODULE0__$3d3e$__$225b$project$5d2f$app$2f$login$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29222c$__ACTIONS_MODULE1__$3d3e$__$225b$project$5d2f$app$2f$actions$2f$lessons$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29222c$__ACTIONS_MODULE2__$3d3e$__$225b$project$5d2f$app$2f$actions$2f$makeup$2d$slots$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29222c$__ACTIONS_MODULE3__$3d3e$__$225b$project$5d2f$app$2f$actions$2f$stripe$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29222c$__ACTIONS_MODULE4__$3d3e$__$225b$project$5d2f$app$2f$actions$2f$pricing$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29222c$__ACTIONS_MODULE5__$3d3e$__$225b$project$5d2f$app$2f$messages$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$2922$__$7d$__$5b$app$2d$rsc$5d$__$28$server__actions__loader$2c$__ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i('[project]/.next-internal/server/app/student/page/actions.js { ACTIONS_MODULE0 => "[project]/app/login/actions.ts [app-rsc] (ecmascript)", ACTIONS_MODULE1 => "[project]/app/actions/lessons.ts [app-rsc] (ecmascript)", ACTIONS_MODULE2 => "[project]/app/actions/makeup-slots.ts [app-rsc] (ecmascript)", ACTIONS_MODULE3 => "[project]/app/actions/stripe.ts [app-rsc] (ecmascript)", ACTIONS_MODULE4 => "[project]/app/actions/pricing.ts [app-rsc] (ecmascript)", ACTIONS_MODULE5 => "[project]/app/messages/actions.ts [app-rsc] (ecmascript)" } [app-rsc] (server actions loader, ecmascript) <locals>');
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$login$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/login/actions.ts [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$actions$2f$lessons$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/actions/lessons.ts [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$actions$2f$makeup$2d$slots$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/actions/makeup-slots.ts [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$actions$2f$stripe$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/actions/stripe.ts [app-rsc] (ecmascript)");
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b16389e9._.js.map