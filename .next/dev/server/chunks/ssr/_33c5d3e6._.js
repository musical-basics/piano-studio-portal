...
"[project]/app/actions/data:22b581 [app-ssr] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
"[project]/app/actions/data:473db6 [app-ssr] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
"[project]/app/actions/data:8935a3 [app-ssr] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$actions$2f$data$3a$22b581__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/app/actions/data:22b581 [app-ssr] (ecmascript) <text/javascript>");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$actions$2f$data$3a$473db6__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/app/actions/data:473db6 [app-ssr] (ecmascript) <text/javascript>");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$actions$2f$data$3a$8935a3__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/app/actions/data:8935a3 [app-ssr] (ecmascript) <text/javascript>");
...
function AdminDashboard({ admin, todaysLessons, scheduledLessons, completedLessons, students, totalUnread }) {
    ...
    const handleSaveLesson = async ()=>{
        ...
        setIsLoading(true);
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$actions$2f$data$3a$22b581__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["logLesson"])(selectedLesson.id, lessonNotes, videoUrl || undefined, sheetMusicUrl || undefined);
        setIsLoading(false);
        if (result.error) {
            toast({
                variant: "destructive",
    ...
    const handleMarkNoShow = async (lesson)=>{
        if (confirm(`Mark ${lesson.student.name} as No-Show? This will deduct 1 credit without refund or makeup option.`)) {
            setIsLoading(true);
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$actions$2f$data$3a$473db6__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["markNoShow"])(lesson.id);
            setIsLoading(false);
            if (result.error) {
                toast({
                    variant: "destructive",
    ...
    const handleScheduleLesson = async ()=>{
        ...
        setIsLoading(true);
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$actions$2f$data$3a$8935a3__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["scheduleLesson"])(selectedStudent.id, scheduleDate, scheduleTime, scheduleDuration);
        setIsLoading(false);
        if (result.error) {
            toast({
                variant: "destructive",
...
//# sourceMappingURL=_33c5d3e6._.js.map