...
"[project]/app/actions/data:4c4c02 [app-ssr] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
"[project]/app/actions/data:526348 [app-ssr] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$actions$2f$data$3a$4c4c02__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/app/actions/data:4c4c02 [app-ssr] (ecmascript) <text/javascript>");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$actions$2f$data$3a$526348__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/app/actions/data:526348 [app-ssr] (ecmascript) <text/javascript>");
...
function AdminDashboard({ admin, todaysLessons, students, totalUnread }) {
    ...
    const handleSaveLesson = async ()=>{
        ...
        setIsLoading(true);
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$actions$2f$data$3a$4c4c02__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["logLesson"])(selectedLesson.id, lessonNotes, videoUrl || undefined, sheetMusicUrl || undefined);
        setIsLoading(false);
        if (result.error) {
            toast({
                variant: "destructive",
    ...
    const handleMarkNoShow = async (lesson)=>{
        if (confirm(`Mark ${lesson.student.name} as No-Show? This will deduct 1 credit without refund or makeup option.`)) {
            setIsLoading(true);
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$actions$2f$data$3a$526348__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["markNoShow"])(lesson.id);
            setIsLoading(false);
            if (result.error) {
                toast({
                    variant: "destructive",
...
//# sourceMappingURL=_8f10f512._.js.map